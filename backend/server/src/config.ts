...
export class Config {
  ...
  'jhipster.mail.from' = 'dehet@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'dehet API';
  'jhipster.swagger.description' = 'dehet API documentation';
  ...
  'eureka.instance.appname' = 'dehet';
  'eureka.instance.instanceId' = 'dehet:${random.value}';
